# Hi 
<p>  I'm  is <strong>Ibrahima DANSOKO</strong>  **Full Stack Developer** with over **5 years of experiences**, I am also enthusiastic about **Cyber Security and DevOps**.  </p>

- **MBTI**: INFJ, reflecting my introspective nature and passion for meaningful projects.
- 🌐 **Based in Paris**, I work in a vibrant and international environment.
- 💻 My passion for coding is primarily evident in my **JavaScript projects**.
- I am particularly committed to producing **clean and well-tested code**, believing in the quality and sustainability of software.
- 🚀 Currently, I'm focusing on projects using **React (React Js / React Native) with Remix | Next.js | Expo** and **Express Js / NestJS**.
